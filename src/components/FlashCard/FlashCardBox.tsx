...
import { useFlashcardMeta } from "../../hooks/useFlashcards";
...
export const FlashCardBox = ({ themes, limit, onStudyModeChange }: Props) => {
  const { data, isLoading, isError, error } = useFlashcardMeta(limit, themes);
